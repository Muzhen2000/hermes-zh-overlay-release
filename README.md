...
- 官方 Hermes commit：`88b6eb9ad1be4c778c589218c7c759c4e0d31c7e`
- 中文包 release：`88b6eb9`
...
```bash
curl -fsSL https://raw.githubusercontent.com/Muzhen2000/hermes-zh-overlay-release/main/scripts/apply_release.py | python3 - --release 88b6eb9
```
